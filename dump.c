...
void obtainEssentials(int*cash, int*ppbLem, int*ppbLav, int*ppbRos, int*ppbMin, int*lemonDrops, int*lavenderDrops, int*rosemaryDrops, int*mintDrops,int*avblLem, int*avblLav, int*avblRos, int*avblMin) 
{
...
printf("||_||||||||||_|||||||||||||_||||||||||_||\n");
  ...
  while (option != 5) {
      switch(option){
                ...
                case 1:
          printf("\n\t[You chose to look at Lemon Oil]");
          printf("\nPress 1. Buy Lemon Oils.");
          printf("\nPress 2. Sell Lemon Oils.\n[Enter Choice]: ");
          scanf("%d", &c);
          if(c==1){
            printf("\n\t[Buying Lemon Oil]");
        ...
        //////////////////////////////////////////////////////////////
        case 2:
          printf("\n\t[You chose to look at Lavender Oil]");
          printf("\nPress 1. Buy Lavender Oils.");
          printf("\nPress 2. Sell Lavender Oils.\n[Enter Choice]: ");
          scanf("%d", &c);
          if(c==1){
            printf("\n\t[Buying Lavender Oil]");
            printf("\nPlease enter the number of bottles: ");
        ...
        //////////////////////////////////////////////////////////////
        case 3:
          printf("\n\t[You chose to look at Rosemary Oil]");
          printf("\nPress 1. Buy Rosemary Oils.");
          printf("\nPress 2. Sell Rosemary Oils.\n[Enter Choice]: ");
          scanf("%d", &c);
          if(c==1){
            printf("\n\t[Buying Rosemary Oil]");
            printf("\nPlease enter the number of bottles: ");
        ...
        //////////////////////////////////////////////////////////////
        case 4:
          printf("\n\t[You chose to look at Mint Oil]");
          printf("\nPress 1. Buy Mint Oils.");
          printf("\nPress 2. Sell Mint Oils.\n[Enter Choice]: ");
          scanf("%d", &c);
          if(c==1){
            printf("\n\t[Buying Mint Oil]");
            printf("\nPlease enter the number of bottles: ");
...
{ 
    ...
    while(g == 1){
      for (q = 0; q <day ; q++){
        ...
        if(option == 1 || option == 2 ) //buy and sell
        {
          ...
          obtainEssentials(&cash, &ppbLem, &ppbLav, &ppbRos, &ppbMin, &lemonDrops, &lavenderDrops, &rosemaryDrops, &mintDrops, &avblLem, &avblLav, &avblRos, &avblMin);
        ...
        else if (option == 5)//travel
        {
          ...
          printf("|    0. Manila       2. Quezon City        |\n");    
          printf("|    1. Makati       3. Alabang            |\n");
          printf("============================================\n");
          printf("Current Location: %s\n", cityLocations[currentLocation]);
          printf("\nEnter choice: ");
          scanf("%d", &select);
          if(select != currentLocation && select <= 3){
            if (select == 0){ //manila
              currentLocation = 0;
              currentDay +=1 ; 
              if(loan > 0){ //BAT AYAW
        ...
        else if (option == 6)//Exit
        {
          ...
          g=1;
          //abort();
          //HAHAHAHHAHAHAHAHAHAHAHAH BAKA YAN PDE
          strcpy( command, "dir" );
   system(command);
        } 
